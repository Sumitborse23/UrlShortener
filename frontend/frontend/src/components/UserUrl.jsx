              ...
              <tr key={url._id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4">
                  <div className="text-sm">
                    <a 
                      href={`https://urlshortener-backend-jr6i.onrender.com${url.short}`} 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="text-blue-600 hover:text-blue-900 hover:underline"
                    >
                      {`https://urlshortener-backend-jr6i.onrender.com${url.short}`}
                    </a>
                  </div>
                </td>
                <td className="px-6 py-4">
                ...
                <td className="px-6 py-4 text-sm font-medium">
                  <button
                    onClick={() => handleCopy(`https://urlshortener-backend-jr6i.onrender.com${url.short}`, url._id)}
                    ...
                    } focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-700`}
                  >
                    {copiedId === url._id ? (
                      <>
